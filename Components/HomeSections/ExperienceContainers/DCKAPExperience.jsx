const DCKAPExperience = () => {
    let companyName = "DCKAP"
                ...
                <figure className="md:flex bg-black rounded-xl p-8 md:p-0"
                    ...
                    <div className="d-flex rounded">
                        <img className="h-45 md:w-5/12 md:h-auto mx-auto"
                            ...
                            src={process.env.LINK + "/images/company/dckap.jpg"} alt={companyName} height="512" />
                        <div className="  bg-black pt-2 md:p-8 text-center md:text-left space-y-4">
                            <p className=" pl-1 pr-1 text-justify leading-relaxed fontComic text-base font-18">
                                I'm working as full-stack developer at <span id='companyClass' className='text-light-orange' >{companyName} </span>
...
export default DCKAPExperience;