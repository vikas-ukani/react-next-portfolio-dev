export const EducationSection = () => (
    <div className="elementor-column elementor-col-50 elementor-top-column elementor-element elementor-element-3bd09292" data-element_type="column">
            ...
            <div className="elementor-widget-wrap">
                <div className="elementor-element elementor-element-7ecab251 elementor-widget elementor-widget-heading"
                    ...
                    <div className="elementor-widget-container">
                        <h2 className="elementor-heading-title elementor-size-default"> Education </h2>
                    </div>
                </div>
                <div className="elementor-element elementor-element-78c7f924 global-color elementor-widget elementor-widget-text-editor"
                    ...
                    <div className="elementor-widget-container">
                        ...
                        ipsum dolor sit amet, consectetur adipiscing elit.
                            Viverra tristique placerat in massa consectetur quisque nunc fames.</div>
                    </div>
                </div>
                ...
                <div className="elementor-element elementor-element-2be89b60 elementor-widget elementor-widget-text-editor"
                    ...
                    <div className="elementor-widget-container">
                        ...
                        mauris, condimentum ut tincidunt eu, mattis euismod dolor.</div>
                    </div>
                </div>
