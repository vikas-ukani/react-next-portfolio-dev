...
export default function Blogs() {
	...
	<section className="skewed-bottom-right">
		<nav className="relative px-6 py-6 flex justify-between items-center bg-green-600">
			<a className="text-white text-3xl font-bold leading-none" href="#"> <img className="h-12" src="atis-assets/logo/atis/atis-mono-light.svg" alt="" width="auto" /> </a>
			...
			<ul className="hidden absolute top-1/2 left-1/2 transform -translate-y-1/2 -translate-x-1/2 lg:flex lg:mx-auto lg:flex lg:items-center lg:w-auto lg:space-x-6">
				<li> <a className="text-sm text-gray-50 hover:text-gray-100" href="#">Start</a> </li>
				...
				<li> <a className="text-sm text-gray-50 hover:text-gray-100" href="#">Services</a> </li>
				<li className="text-green-500">
					<svg className="w-4 h-4 current-fill" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
						<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 5v.01M12 12v.01M12 19v.01M12 6a1 1 0 110-2 1 1 0 010 2zm0 7a1 1 0 110-2 1 1 0 010 2zm0 7a1 1 0 110-2 1 1 0 010 2z"> </path>
					</svg>
				</li>
				<li> <a className="text-sm text-gray-50 hover:text-gray-100" href="#">Platform</a> </li>
				<li className="text-green-500">
					<svg className="w-4 h-4 current-fill" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
						<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 5v.01M12 12v.01M12 19v.01M12 6a1 1 0 110-2 1 1 0 010 2zm0 7a1 1 0 110-2 1 1 0 010 2zm0 7a1 1 0 110-2 1 1 0 010 2z"> </path>
					</svg>
				</li>
				<li> <a className="text-sm text-gray-50 hover:text-gray-100" href="#">Testimonials</a> </li>
			</ul> <a className="hidden lg:block py-2 px-6 bg-white hover:bg-gray-50 text-sm text-green-600 font-bold rounded-l-xl rounded-t-xl transition duration-200" href="#">
                            Contact Us
                        </a> </nav>
					...
					<div className="w-full lg:w-1/2 px-4 mb-12 md:mb-20 lg:mb-0 flex items-center">
						<div className="w-full text-center lg:text-left">
							<div className="max-w-md mx-auto lg:mx-0 text-white">
								<h2 className="mb-3 text-4xl lg:text-5xl text-white font-bold">Build &amp; Launch without problems</h2> </div>
							<div className="max-w-sm mx-auto lg:mx-0">
								...
								<div> <a className="inline-block mb-3 lg:mb-0 lg:mr-3 w-full lg:w-auto py-2 px-6 leading-loose bg-white hover:bg-gray-50 text-green-600 font-semibold rounded-l-xl rounded-t-xl transition duration-200" href="#">Get Started</a> <a className="inline-block w-full lg:w-auto py-2 px-6 leading-loose text-white font-semibold bg-green-600 border-2 border-green-400 hover:border-green-500 rounded-l-xl rounded-t-xl transition duration-200" href="#">How it works</a> </div>
							</div>
						</div>
					</div>
					<div className="w-full lg:w-1/2 px-4 flex items-center justify-center">
						<div className="relative" style="z-index: 0;"> <img className="h-128 w-full max-w-lg object-cover rounded-3xl md:rounded-br-none" src="https://images.unsplash.com/photo-1462826303086-329426d1aef5?ixlib=rb-1.2.1&amp;ixid=MXwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHw%3D&amp;auto=format&amp;fit=crop&amp;w=1050&amp;q=80" alt="" /> <img className="hidden md:block absolute" style="top:-2rem; right: 3rem; z-index: -1;" src="atis-assets/elements/green-up.svg" alt="" /> <img className="hidden md:block absolute" style="bottom:-2rem; right: -2rem; z-index: -1;" src="atis-assets/elements/wing-green-down.svg" alt="" /> <img className="hidden md:block absolute" style="top:3rem; right: -3rem; z-index: -1;" src="atis-assets/elements/bullets-green-right.svg" alt="" /> <img className="hidden md:block absolute" style="bottom:2.5rem; left: -4.5rem; z-index: -1;" src="atis-assets/elements/bullets-green-left.svg" alt="" /> </div>
					</div>
				</div>
			</div>
		</div>
		...
		<div className="hidden navbar-menu relative z-50">
			...
			<nav className="fixed top-0 left-0 bottom-0 flex flex-col w-5/6 max-w-sm py-6 px-6 bg-white border-r overflow-y-auto">
				...
				<div className="mt-auto">
					...
					<p className="my-4 text-xs text-center text-gray-400"> <span>© 2020 All rights reserved.</span> </p>
					<div className="text-center">
						<a className="inline-block px-1" href="#"> <img src="atis-assets/social/facebook.svg" alt="" /> </a>
						<a className="inline-block px-1" href="#"> <img src="atis-assets/social/twitter.svg" alt="" /> </a>
						<a className="inline-block px-1" href="#"> <img src="atis-assets/social/instagram.svg" alt="" /> </a>
					</div>
				</div>
			</nav>
		</div>
		...
		<div className="content-holder center-relative content-1300 post-186 post type-post status-publish format-standard has-post-thumbnail hentry category-uncategorized">
						...
						<div className="center-text">
							<ul className="entry-info">
								<li className="author-nickname-holder">
									...
									<div className="author-nickname"> <a href="https://demo.cocobasic.com/volos-wp/demo-3/author/ricky-stone/" title="Posts by Ricky Stone" rel="author">Ricky Stone</a> </div>
								</li>
								...
								<li className="cat-links-holder">
									...
									<div className="cat-links-wrapper">
										<ul className="cat-links">
											<li> <a href="https://demo.cocobasic.com/volos-wp/demo-3/category/uncategorized/">Uncategorized</a> </li>
										</ul>
									</div>
								</li>
								<li className="num-comments-holder">
									<div className="entry-info-text"> COMMENTS</div>
									<div className="num-comments"> <a href="https://demo.cocobasic.com/volos-wp/demo-3/2019/11/27/preserve-and-cherish-that-pale-blue-dot-are-creatures-of-the-cosmos-light-years/#respond">No Comments</a> </div>
								</li>
							</ul>
						</div> <img width="1150" height="450" src="https://demo.cocobasic.com/volos-wp/demo-3/wp-content/uploads/2019/11/img_blog_02.jpg" className="attachment-post-thumbnail size-post-thumbnail wp-post-image" alt="" loading="lazy" srcset="https://demo.cocobasic.com/volos-wp/demo-3/wp-content/uploads/2019/11/img_blog_02.jpg 1150w, https://demo.cocobasic.com/volos-wp/demo-3/wp-content/uploads/2019/11/img_blog_02-300x117.jpg 300w, https://demo.cocobasic.com/volos-wp/demo-3/wp-content/uploads/2019/11/img_blog_02-1024x401.jpg 1024w, https://demo.cocobasic.com/volos-wp/demo-3/wp-content/uploads/2019/11/img_blog_02-768x301.jpg 768w" sizes="(max-width: 1150px) 100vw, 1150px" />
			...
			<div className="nav-links content-750 center-relative">
				<div className="nav-previous">
					<p>PREVIOUS STORY</p> <a href="https://demo.cocobasic.com/volos-wp/demo-3/2019/11/26/great-turbulent-clouds-hearts-of-the-stars-stirred-by-starlight-sky-culture/" rel="prev">Great turbulent clouds hearts of the stars stirred by starlight sky culture</a>
					<div className="clear"> </div>
				</div>
				<div className="nav-next">
					<p>NEXT STORY</p> <a href="https://demo.cocobasic.com/volos-wp/demo-3/2019/11/28/hundreds-of-thousands-a-still-more-glorious-nights-around-art-table/" rel="next">Hundreds of thousands a still more glorious nights around art table</a>
					<div className="clear"> </div>
				</div>
				<div className="clear"> </div>
			</div>
